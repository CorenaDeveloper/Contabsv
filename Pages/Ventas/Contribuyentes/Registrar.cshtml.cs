...
namespace Contabsv_core.Pages.Ventas.Contribuyentes
{
    [Authorize]
    public class RegistrarModel : PageModel
    {
        ...
        [BindProperty]
        public VentasContribuyentes ventasContribuyente{ get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            ventasContribuyente.idCliente = idCliente;

            bool success = await _apiService.RegistrarContribuyentes(ventasContribuyente);
            if (success)
            {
